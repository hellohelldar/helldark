...
const App: React.FC = () => {
  ...
  // Animate progress bar with GSAP for smoother updates
  useEffect(() => {
  ...
  return (
    <div className="relative min-h-screen bg-dark-bg text-slate-300 font-sans selection:bg-white selection:text-black">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-0 bg-dark-bg">
        ...
        <div className="absolute top-[-20%] left-[-10%] w-[50%] h-[50%] bg-gradient-to-br from-green-500/8 to-transparent blur-[150px] rounded-full opacity-30" />
        <div className="absolute bottom-[-10%] right-[-5%] w-[40%] h-[40%] bg-gradient-to-tl from-green-500/8 to-transparent blur-[120px] rounded-full opacity-25" />
        <div className="absolute top-[40%] left-[50%] -translate-x-1/2 w-[600px] h-[600px] bg-accent/3 blur-[200px] rounded-full opacity-15" />
      ...
      <div
        ...
        style={{ 
          boxShadow: '0 0 10px rgba(255,255,255,0.5), 0 0 20px rgba(46,255,113,0.3)',
          width: '0%'
        }}
      />
